...
public final class Address {
    @Getter @Setter(AccessLevel.PUBLIC) private String country;
    @Getter @Setter(AccessLevel.PUBLIC) private String zipCode;
    @Getter @Setter(AccessLevel.PUBLIC) private String state;
    @Getter @Setter(AccessLevel.PUBLIC) private String road;
    ...
    public void validate() throws InvalidAddressException {
        ...
        if (zipCode == null || !zipCode.matches("\\d{5}")) {
            throw new InvalidAddressException("Invalid zip code format");
        }
        if (state == null || road == null) {
            throw new InvalidAddressException("Road or Street cannot be null");
        }
    }
